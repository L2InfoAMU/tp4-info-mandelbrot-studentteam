...
public class ComplexTest {
    ...
    void testAdd()
    {
        ...
        assertEquals(oneMinusI, minusI.add(Complex.ONE));
    }
    ...
    void testSquaredModulus()
    {
        ...
        assertEquals(3*3+5*5, new Complex(3, 5).squaredModulus());
    }

    @Test
    void testModulus()
    {
        assertEquals(Math.sqrt(oneMinusI.squaredModulus()), oneMinusI.modulus());
        assertEquals(Math.sqrt(2*2+3*3), new Complex(2, 3).modulus());
    }
    ...
    void testIsEquals()
    {
        ...
        assertNotEquals(new Complex(1, 2), new Complex(2, 1));
        assertNotEquals(Complex.I, Complex.ONE);
    }
}